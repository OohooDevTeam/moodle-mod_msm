...
//            $captionNode->appendChild($captionText);
        ...
        if (!empty($flag))
        { // comment is a reference material (ie. ExportAssociate called this function)
        ...
        { // comment is a main part of the unit (ie. ExportUnit or ExportSubordinate called this function)
            return $commentNode;
        }
    }
