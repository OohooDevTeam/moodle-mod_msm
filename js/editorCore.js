    ...
    if (files[0].type.match('image.*')) {
        ...
        reader.onload = (function(theFile) {
            return function(e) {
                ...
                div.className = "msm_img_previews";
                div.id = "msm_img_preview-"+filepickerId[1]+"-";
                ...
                image.onclick = "resizeThumbnail(event)";

                div.appendChild(image);
                document.getElementById('msm_file_list-'+filepickerId[1]).insertBefore(div, null);
...
function resizeThumbnail(e)
{
    var currentElement = e.target.id;
