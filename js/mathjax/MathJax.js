    ...
    if(!MathJax.Hub){
        ...
        MathJax.Hub={
                ...
                while(c.j<c.jaxIDs.length){
                    ...
                    if(d[f]){
                        try{
                            ...
                            if(!b.restart){
                                MathJax.Message.Set("Error preparing "+e+" output ("+f+")",null,600);
            ...
            processMessage:function(d,b){
                ...
                var c=(b==="Output"?"Typesetting":"Processing");
                if(this.config.showProcessingMessages){
                    MathJax.Message.Set(c+" math: "+a+"%",0)
                }
            },
            ...
            formatError:function(a,c){
                var b=MathJax.HTML.Element("span",{
                    className:"MathJax_Error"
                },this.config.errorSettings.message);
                b.jaxID="Error";
                if(MathJax.Extension.MathEvents){
                    b.oncontextmenu=MathJax.Extension.MathEvents.Event.Menu;
                    b.onmousedown=MathJax.Extension.MathEvents.Event.Mousedown
                }else{
        ...
        MathJax.Hub.Startup={
            ...
            Config:function(){
                ...
                this.queue.Push(["ConfigDelay",this],["ConfigBlocks",this],["ConfigDefault",this],[function(e){
            ...
            ConfigDefault:function(){
                ...
                if(a["v1.0-compatible"]&&(a.jax||[]).length===0&&!this.params.config&&(a.config||[]).length===0){
            ...
            MenuZoom:function(){
                if(!MathJax.Extension.MathMenu){
                    setTimeout(MathJax.Callback(["Require",MathJax.Ajax,"[MathJax]/extensions/MathMenu.js",{}]),1000)
                }
            ...
            b.OutputJax.Error={
                ...
                getJaxFromMath:function(){
                    return{
                        inputJax:"Error",
                        outputJax:"Error",
                        originalText:"Math Processing Error"
                    }
                }
            };
        ...
        (function(l){
            ...
            c.Browser.Select({
                ...
                Firefox:function(j){
                    ...
                    j.isMobile=(navigator.appVersion.match(/Android/i)!=null||navigator.userAgent.match(/ Fennec\//)!=null)
                },
                Opera:function(i){
