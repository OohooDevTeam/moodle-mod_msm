...
{ 
    ...
    YUI().use('editor_tinymce', function(Y) {
        M.editor_tinymce.init_editor(Y, elId, {
            mode:"exact",
            elements: elId,
            plugins:"matheditor,subordinate,safari,table,style,layer,advhr,advlist,emotions,inlinepopups,imagemapper,searchreplace,paste,directionality,fullscreen,nonbreaking,contextmenu,insertdatetime,save,iespell,preview,print,noneditable,visualchars,xhtmlxtras,template,pagebreak,-dragmath,-moodlenolink,-spellchecker,-moodleimage,-moodlemedia",
            width: "100%",
            height: "70%",
            theme_advanced_font_sizes:"1,2,3,4,5,6,7",
            theme_advanced_layout_manager:"SimpleLayout",
